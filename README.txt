...
== Description ==
The Peach Payments extension for WooCommerce is a South African payment gateway that allows merchants access to various payment methods, including credit/debit cards, bank transfers, mobile wallets, electronic wallets and mobile operator billing to help them succeed in emerging markets.
